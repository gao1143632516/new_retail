      ...
      <el-tab-pane label="基本信息" name="first">
        <el-form ref="form" :model="goods" :rules="rules" label-width="100px">
          ...
          <el-form-item label="商品编号" prop="goods_code">
            <el-input v-model.trim="goods.goods_code"></el-input>
          </el-form-item>
          ...
          <el-form-item label="来源">
            <el-input type="text" v-model="goods.supplier" placeholder="来源"></el-input>
          </el-form-item>
      ...
      <el-tab-pane label="sku" name="second">
        ...
        <el-row type="flex" align="middle">
          ...
          <el-col :offset="1" :span="20">
            ...
            >
              <el-table-column prop="sku_name" label="SKU" width="100"></el-table-column>
              ...
              <el-table-column prop="sku_cost_price" label="成本价格" width="100">
                <template slot-scope="scope">
                  <el-input type="number" min="0" v-model="scope.row.sku_cost_price" size="small"></el-input>
                </template>
              </el-table-column>
              <el-table-column prop="sku_retail_price" label="零售价格" width="100">
                <template slot-scope="scope">
                  <el-input type="number" min="0" v-model="scope.row.sku_retail_price" size="small"></el-input>
                </template>
              </el-table-column>
                  <el-table-column prop="sku_retail_price" label="原价" width="100">
                <template slot-scope="scope">
              ...
              <el-table-column prop="sku_num" label="库存" width="100">
                <template slot-scope="scope">
                  <el-input type="number" min="0"  v-model="scope.row.sku_num" size="small" :disabled="isEdit"></el-input>
                </template>
              </el-table-column>
              <el-table-column prop="sku_num_upper_limit_value" label="库存上限值" width="100">
                <template slot-scope="scope">
                  <el-input type="number" min="0" v-model="scope.row.sku_num_upper_limit_value" size="small"></el-input>
                </template>
              </el-table-column>
              <el-table-column prop="sku_num_lower_limit_value" label="库存下限值" width="100">
                <template slot-scope="scope">
                  <el-input type="number" min="0" v-model="scope.row.sku_num_lower_limit_value" size="small"></el-input>
                </template>
              </el-table-column>
              <el-table-column prop="sku_reward" label="返现" width="100">
                <template slot-scope="scope">
                  <el-input type="number" min="0" v-model="scope.row.sku_reward" size="small"></el-input>
                </template>
              </el-table-column>
              <el-table-column  label="超量购买" width="100">
                <template slot-scope="scope">
  ...
  methods: {
    ...
    saveForm(formName) {
      ...
      for(let spec of goods_bak.specifications){
        console.log(spec.sku_num,spec.sku_cost_price,spec.sku_retail_price)
        if(spec.sku_num === "" || spec.sku_cost_price === "" || spec.sku_retail_price === ""){
           this.$message.error("商品规格数量和价格不能为空！");
           return false;
        }
        spec.sku_cost_price = yuanTofen(spec.sku_cost_price);
        spec.sku_retail_price = yuanTofen(spec.sku_retail_price);
...
//      goods_bak.min_price = yuanTofen(goods_bak.min_price);
//      goods_bak.max_price = yuanTofen(goods_bak.max_price);
      goods_bak.max_price = goods_bak.specifications[0].sku_retail_price;
      goods_bak.min_price = goods_bak.specifications[0].sku_retail_price;
